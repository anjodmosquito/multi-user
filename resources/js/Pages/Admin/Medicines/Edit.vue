<template>
      ...
      <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
          <div class="flex justify-end m-2 p-2">
            <Link href="/admin/medicines" class="px-4 py-2 bg-indigo-500 hover:bg-indigo-600 text-white rounded">Back</Link>
          </div>
  
          <div class="flex">
            <form @submit.prevent="updateMedicine" class="max-w-md mx-auto">
  ...
  const form = useForm({
    ...
    lprice: props.medicine.lprice,
    mprice: props.medicine.mprice,
    hprice: props.medicine.hprice,
    quantity: props.medicine.quantity,
    dosage: props.medicine.dosage,
    expdate: props.medicine.expdate,
  });
  
  function updateMedicine() {
  form.put(route('admin.medicines.update', props.medicine.id));
  }
  </script>